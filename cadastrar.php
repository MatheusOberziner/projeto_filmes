...
<?php
    if (isset($_POST['gravar'])) {
        $sql_filme_salvar = "INSERT into filmes
                             ...
                             VALUES(:nome,:resumo,:ano,:imagem,:complementos)
        ";
...
<form method="post">
    ...
    <div class="form-floating">
        <textarea class="form-control" name="imagem" placeholder="Digite o resumo" id="floatingTextarea2" style="height: 100px"></textarea>
        <label for="floatingTextarea2">Imagem</label>
    </div>

    <div class="form-floating">
        <textarea class="form-control" name="complementos" placeholder="Digite o resumo" id="floatingTextarea2" style="height: 100px"></textarea>
