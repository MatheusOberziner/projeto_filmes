...
<table class="table">
    ...
    <tr>
        ...
        <td>
            <div class="form-floating">
                <textarea class="form-control" name="imagem" placeholder="Digite o resumo" id="floatingTextarea2" style="height: 100px"><?php echo $filme['imagem']; ?></textarea>
                <label for="floatingTextarea2">Imagem</label>
            </div>
        </td>
    </tr>
    <tr>
        ...
        <td>
            <div class="form-floating">
                <textarea class="form-control" name="complementos" placeholder="Digite o resumo" id="floatingTextarea2" style="height: 100px"><?php echo $filme['complementos']; ?></textarea>
                <label for="floatingTextarea2">Complementos</label>
            </div>
        </td>
    </tr>
</table>
